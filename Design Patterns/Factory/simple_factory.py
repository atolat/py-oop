...
Objective: Design a pizza store class following OOP.
"""

from abc import ABC, abstractmethod


# Client of the Factory - PizzaStore goes to the PizzaFactory to get instances of Pizza 
class PizzaStore:
...
# Factory object where we create the pizza, it should be the only part of our code that refers to the concrete Pizza class
